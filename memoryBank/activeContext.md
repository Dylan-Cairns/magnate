...
- Default browser `Rollout Search` profile uses `worlds=10`, `rollouts=4`, `depth=12`, `maxRootActions=8`, and `rolloutEpsilon=0` to make the web opponent stronger while preserving deterministic rollout play.
