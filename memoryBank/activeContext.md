...
- Keep monitoring collect/eval wall-clock and cache-hit summaries with the new default `32` limits, and retune if longer-run production workloads disagree with the fixed-seed benchmark probes.
