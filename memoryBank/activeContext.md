...
- Continue decomposing `App.tsx` around DOM animation targeting, shared action dispatch, and controller hooks while preserving the characterization-tested behavior.
