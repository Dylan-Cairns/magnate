...
- Continue decomposing `App.tsx` around animation lifecycle hooks, shared action dispatch, and controller hooks while preserving the characterization-tested behavior.
