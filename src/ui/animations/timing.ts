...
export const PAYMENT_FLIGHT_DURATION_MS = TURN_CYCLE_TAX_FLIGHT_DURATION_MS;
export const PAYMENT_FLIGHT_STAGGER_MS = TURN_CYCLE_TAX_FLIGHT_STAGGER_MS;
export const SELL_FLIGHT_DURATION_MS = TURN_CYCLE_TAX_FLIGHT_DURATION_MS;
export const SELL_FLIGHT_STAGGER_MS = TURN_CYCLE_TAX_FLIGHT_STAGGER_MS;
