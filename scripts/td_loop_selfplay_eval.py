...
def _build_gate_command_vs_incumbent(
    *,
    python_bin: Path,
    args: argparse.Namespace,
    checkpoint: LoopCheckpoint,
    ...
    command = [
        ...
        str(args.eval_worker_blas_threads),
        "--gate-h0-win-rate",
        str(args.chunk_gate_h0_win_rate),
        "--gate-h1-win-rate",
        str(args.chunk_gate_h1_win_rate),
        "--gate-alpha",
        str(args.chunk_gate_alpha),
        "--gate-beta",
        str(args.chunk_gate_beta),
        "--gate-batch-games-per-side",
        str(batch_games_per_side),
        "--gate-max-games-per-side",
        str(max_games_per_side),
        "--gate-max-side-gap",
        str(args.chunk_gate_max_side_gap),
        "--out",
        str(out_path),
        "--candidate-td-search-value-checkpoint",
        str(checkpoint.value_path),
